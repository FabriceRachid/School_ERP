...
export const schools: School[] = [
  { id: "s1", name: "Lycée Victor Hugo", address: "Rue 12, Plateau, Abidjan", phone: "+225 07 00 00 01", email: "contact@lycee-victor.edu", adminId: "u2", studentsCount: 450, teachersCount: 28, classesCount: 12, status: "active" },
  { id: "s2", name: "Collège Saint-Exupéry", address: "Bd de la Paix, Cocody", phone: "+225 07 00 00 02", email: "contact@college-saint.edu", adminId: "u3", studentsCount: 320, teachersCount: 18, classesCount: 9, status: "active" },
  { id: "s3", name: "École Primaire Les Étoiles", address: "Av. Houphouët, Marcory", phone: "+225 07 00 00 03", email: "contact@etoiles.edu", adminId: "u2", studentsCount: 280, teachersCount: 15, classesCount: 8, status: "inactive" },
];
...
export const classes: ClassRoom[] = [
  { id: "c1", name: "Terminale A", cycleId: "cy1", schoolId: "s1", capacity: 45, studentsCount: 42, mainTeacherId: "t1", fees: 150000 },
  { id: "c2", name: "Terminale D", cycleId: "cy1", schoolId: "s1", capacity: 40, studentsCount: 38, mainTeacherId: "t2", fees: 175000 },
  { id: "c3", name: "Première C", cycleId: "cy1", schoolId: "s1", capacity: 40, studentsCount: 35, mainTeacherId: "t1", fees: 160000 },
  { id: "c4", name: "Seconde A", cycleId: "cy1", schoolId: "s1", capacity: 50, studentsCount: 48, mainTeacherId: "t2", fees: 140000 },
  { id: "c5", name: "3ème", cycleId: "cy2", schoolId: "s2", capacity: 45, studentsCount: 40, fees: 120000 },
  { id: "c6", name: "4ème", cycleId: "cy2", schoolId: "s2", capacity: 45, studentsCount: 43, fees: 110000 },
  { id: "c7", name: "5ème", cycleId: "cy2", schoolId: "s2", capacity: 50, studentsCount: 47, fees: 100000 },
];

export const subjects: Subject[] = [
  { id: "sub1", name: "Mathématiques", coefficient: 5, schoolId: "s1" },
  { id: "sub2", name: "Français", coefficient: 4, schoolId: "s1" },
  { id: "sub3", name: "Physique-Chimie", coefficient: 4, schoolId: "s1" },
  { id: "sub4", name: "SVT", coefficient: 3, schoolId: "s1" },
  { id: "sub5", name: "Anglais", coefficient: 3, schoolId: "s1" },
  { id: "sub6", name: "Histoire-Géo", coefficient: 3, schoolId: "s1" },
  { id: "sub7", name: "Philosophie", coefficient: 4, schoolId: "s1" },
  { id: "sub8", name: "Mathématiques", coefficient: 4, schoolId: "s2" },
  { id: "sub9", name: "Français", coefficient: 4, schoolId: "s2" },
  { id: "sub10", name: "SVT", coefficient: 3, schoolId: "s2" },
];
...
export const teachers: Teacher[] = [
  { id: "t1", userId: "u4", firstName: "Ibrahim", lastName: "Traoré", phone: "+225 07 11 22 33", schoolId: "s1", subjects: ["sub1", "sub3"], classes: ["c1", "c3"] },
  { id: "t2", userId: "u5", firstName: "Aminata", lastName: "Diallo", phone: "+225 07 44 55 66", schoolId: "s1", subjects: ["sub2", "sub7"], classes: ["c2", "c4"] },
  { id: "t3", userId: "u6", firstName: "Kofi", lastName: "Mensah", phone: "+225 07 77 88 99", schoolId: "s2", subjects: ["sub10"], classes: ["c5", "c6", "c7"] },
];
