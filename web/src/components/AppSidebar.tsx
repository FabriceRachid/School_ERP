...
import {
  ...
  CreditCard, FileText, BarChart3, ClipboardList, UserCheck, Settings, LogOut,
} from "lucide-react";
...
const teacherItems = [
  ...
  { title: "Saisie Notes", url: "/teacher/grades", icon: ClipboardList },
  { title: "Présences", url: "/teacher/attendance", icon: UserCheck },
    ...
    <Sidebar className="border-r-0">
      <div className="p-4 flex items-center gap-3 border-b border-sidebar-border">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-display font-bold text-sm text-sidebar-foreground truncate">EduPro ERP</p>
