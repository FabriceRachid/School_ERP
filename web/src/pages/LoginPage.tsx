...
const LoginPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (success) {
        toast({ title: "Connexion réussie", description: "Bienvenue sur EduPro ERP" });
        navigate("/");
      } else {
  ...
  const demoAccounts = [
    ...
    { label: "Admin École", email: "admin@lycee-victor.edu", password: "admin123" },
    { label: "Enseignant", email: "prof.math@lycee-victor.edu", password: "prof123" },
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-accent/10 p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-foreground">EduPro ERP</h1>
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent>
            ...
            <div className="mt-6 pt-6 border-t">
              <p className="text-xs text-muted-foreground mb-3 font-medium">Comptes de démonstration :</p>
              <div className="space-y-2">
