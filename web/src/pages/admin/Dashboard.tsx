...
import { getClassesBySchool, getStudentsBySchool, getTeachersBySchool, getPaymentsBySchool } from "@/data/mock-data";
...
const AdminDashboard = () => {
  ...
  return (
    <DashboardLayout>
      <PageHeader title="Dashboard École" description="Vue d'ensemble de votre établissement" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 animate-fade-in">
        ...
        <StatCard title="Recettes" value={`${(totalRevenue / 1000).toFixed(0)}K FCFA`} icon={CreditCard} color="primary" />
      </div>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={classChartData}>
                ...
                <Tooltip />
                <Bar dataKey="effectif" fill="hsl(234, 89%, 56%)" radius={[6, 6, 0, 0]} />
