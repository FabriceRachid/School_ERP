...
import SchoolManagementPage from "./pages/admin/SchoolManagement";
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/super-admin/notifications" element={<AuthGuard><NotificationsPage /></AuthGuard>} />

    {/* Admin École */}
    <Route path="/admin" element={<AuthGuard><AdminDashboard /></AuthGuard>} />
    <Route path="/admin/students" element={<AuthGuard><SchoolManagementPage /></AuthGuard>} />
    ...
    <Route path="/admin/academic-years" element={<AuthGuard><AcademicYearsPage /></AuthGuard>} />
    <Route path="/admin/settings" element={<AuthGuard><SettingsPage /></AuthGuard>} />
    <Route path="/admin/notifications" element={<AuthGuard><NotificationsPage /></AuthGuard>} />
    ...
    <Route path="/teacher/notifications" element={<AuthGuard><NotificationsPage /></AuthGuard>} />
